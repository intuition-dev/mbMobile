...
console.re.log('split loaded')
//====================================================================
function pgSplit($cont_, speed) {
	console.re.log('spliting:')
